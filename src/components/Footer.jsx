  ...
  <footer id="contactMe" className="bg-gray-900 sm:px-16 px-6">
    ...
    >
      ...
      <div className="md:ml-auto mt-10 md:mt-0">
        <img
          src={profilePic}
          alt="Ravi Shankar Das"
          className="w-[240px] h-[240px] border-2 border-teal-200 relative z-[5] rounded-full"
        />
      </div>
    </div>
    <div className="text-center font-poppins font-normal text-dimWhite text-xs sm:text-sm pb-4">
      <p>
        Made with 💙 by Ravi Shankar Das & the Open Source Community
      </p>
    </div>
  </footer>
);
